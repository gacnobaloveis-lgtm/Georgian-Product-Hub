    ...
    <div className="min-h-screen bg-mesh pb-20 md:pb-0">
      ...
      <div className="mx-auto hidden max-w-6xl px-4 pb-4 pt-3 sm:px-6 md:block lg:px-8">
        <nav className="flex items-center justify-between rounded-2xl bg-white/80 backdrop-blur-sm border border-purple-200/60 shadow-sm px-5 py-2">
          ...
          {onlineData && onlineData.count > 0 && (
            <div className="flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1" data-testid="badge-online-count">
              <span className="relative flex h-1.5 w-1.5 shrink-0">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-emerald-500"></span>
              </span>
              <span className="text-[11px] font-semibold text-emerald-700 whitespace-nowrap">საიტზეა {onlineData.count}</span>
            </div>
          )}
