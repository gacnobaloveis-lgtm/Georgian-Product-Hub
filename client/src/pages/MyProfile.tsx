...
const GEORGIAN_CITIES = [
  "აბაშა", "ამბროლაური", "ახალქალაქი", "ახალციხე", "ახმეტა", "ბაღდათი",
  "ბათუმი", "ბოლნისი", "ბორჯომი", "გარდაბანი", "გორი", "გურჯაანი",
  "დედოფლისწყარო", "დმანისი", "დუშეთი", "ვალე", "ვანი", "ზესტაფონი",
  "ზუგდიდი", "თბილისი", "თეთრიწყარო", "თელავი", "თერჯოლა", "კასპი",
  "ლაგოდეხი", "ლანჩხუთი", "მარნეული", "მარტვილი", "მცხეთა", "ნინოწმინდა",
  "ოზურგეთი", "ონი", "რუსთავი", "საგარეჯო", "სამტრედია", "საჩხერე",
  "სენაკი", "სიღნაღი", "ტყიბული", "ფოთი", "ქარელი", "ქობულეთი",
  "ქუთაისი", "ყვარელი", "წალენჯიხა", "წალკა", "წნორი", "წყალტუბო",
  "ჭიათურა", "ხაშური", "ხობი", "ხონი", "ჯვარი",
];
        ...
        <AnimatedShell className="space-y-4 sm:space-y-6">
          ...
          {ordersOpen && (
            <div className="fixed inset-0 z-50 flex items-start justify-center p-4 pt-10 sm:pt-16">
              ...
              {/* Sheet */}
              <div
                className="relative z-10 bg-slate-950/85 backdrop-blur-xl border border-emerald-400/30 text-white rounded-2xl shadow-2xl w-full max-w-md max-h-[75vh] flex flex-col animate-in slide-in-from-bottom-4 fade-in duration-200"
