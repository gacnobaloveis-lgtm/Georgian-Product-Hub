...
export default function LiveContactPage() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="shrink-0 bg-white/95 backdrop-blur border-b border-border shadow-sm">
      ...
      {isAuthenticated && (
        <div className="shrink-0 bg-white/95 backdrop-blur border-t border-border safe-area-bottom">
          <div className="mx-auto max-w-2xl px-4 py-3">
            <div className="flex items-end gap-2">
              <textarea
                ...
                rows={1}
                className="flex-1 resize-none rounded-xl border border-border bg-white px-4 py-2.5 text-sm outline-none focus:border-primary transition-colors"
