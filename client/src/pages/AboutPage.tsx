        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="text-[15px] leading-7 text-muted-foreground">
              spiningebi.ge — საქართველოს წამყვანი სპინინგის საკუთრებების ონლაინ მაღაზია.
              ჩვენ სთავაზობთ მეთევზეებს საუკეთესო სპინინგის ჯოხებს, კოჭებს, წნულებს,
              ვობლერებს და სხვა სათევზაო აქსესუარებს საუკეთესო ფასებად.
            </p>
          </div>
