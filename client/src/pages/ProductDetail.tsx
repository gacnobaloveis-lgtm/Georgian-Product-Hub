...
export default function ProductDetail() {
  ...
  const { data: contactInfo } = useQuery<{ whatsapp: string; phone: string }>({
    ...
    return (
      <div className="min-h-screen" style={PAGE_BG_STYLE}>
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-emerald-500/10 backdrop-blur-md shadow-xl border border-emerald-400/40 text-white p-6 grid grid-cols-2 gap-4 lg:gap-8">
  ...
  if (!product) {
    return (
      <div className="flex min-h-screen items-center justify-center" style={PAGE_BG_STYLE}>
        <div className="text-center rounded-2xl bg-emerald-500/10 backdrop-blur-md shadow-xl border border-emerald-400/40 text-white px-8 py-10">
  ...
  return (
    <div className="min-h-screen" style={PAGE_BG_STYLE}>
      <div className="mx-auto max-w-6xl px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
        <div className="rounded-2xl bg-emerald-500/10 backdrop-blur-md shadow-xl border border-emerald-400/40 text-white px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
