...
export const WATERS: { rivers: WaterInfo[]; lakes: WaterInfo[] } = {
  rivers: [
    ...
    { name: "მდ. დიდი ლიახვი", region: "შიდა ქართლი (გორი)", lat: 42.1, lon: 43.97 , habitat: "mixed" },
    { name: "მდ. პატარა ლიახვი", region: "შიდა ქართლი", lat: 42.12, lon: 44.05 , habitat: "mixed" },
    { name: "მდ. ქსანი", region: "შიდა ქართლი (მუხრანი)", lat: 42.0, lon: 44.42 , habitat: "mixed" },
    ...
    { name: "მდ. ძამა", region: "შიდა ქართლი (ქარელი)", lat: 42.0, lon: 43.85 , habitat: "mixed" },
    { name: "მდ. ტანა", region: "შიდა ქართლი (გორი)", lat: 41.95, lon: 44.05 , habitat: "mixed" },
    { name: "მდ. თეძამი", region: "შიდა ქართლი (კასპი)", lat: 41.95, lon: 44.35 , habitat: "mixed" },
    { name: "მდ. რიონი", region: "იმერეთი (ქუთაისი)", lat: 42.27, lon: 42.71 , habitat: "mixed" },
    { name: "მდ. ცხენისწყალი", region: "ლეჩხუმი (ცაგერი)", lat: 42.65, lon: 42.77 , habitat: "mixed" },
    { name: "მდ. ყვირილა", region: "იმერეთი (ზესტაფონი)", lat: 42.11, lon: 43.05 , habitat: "mixed" },
    { name: "მდ. ხანისწყალი", region: "იმერეთი (ბაღდათი)", lat: 42.05, lon: 42.83 , habitat: "mixed" },
    { name: "მდ. ჯეჯორა", region: "რაჭა (ონი)", lat: 42.58, lon: 43.45 , habitat: "cold" },
    { name: "მდ. ჩხერიმელა", region: "იმერეთი (ხარაგაული)", lat: 42.02, lon: 43.2 , habitat: "mixed" },
    { name: "მდ. ჭიშურა", region: "იმერეთი (თერჯოლა)", lat: 42.2, lon: 42.98 , habitat: "mixed" },
    { name: "მდ. ჩხარა", region: "იმერეთი (თერჯოლა, ჩხარი)", lat: 42.24, lon: 42.95 , habitat: "mixed" },
    { name: "მდ. ენგური", region: "სამეგრელო (ზუგდიდი)", lat: 42.51, lon: 41.87 , habitat: "mixed" },
    { name: "მდ. ჭოროხი", region: "აჭარა (ბათუმი)", lat: 41.6, lon: 41.65 , habitat: "mixed" },
    { name: "მდ. აჭარისწყალი", region: "აჭარა (ქედა)", lat: 41.6, lon: 41.94 , habitat: "mixed" },
    ...
    { name: "მდ. ხობისწყალი", region: "სამეგრელო (ხობი)", lat: 42.32, lon: 41.9 , habitat: "mixed" },
    { name: "მდ. ტეხური", region: "სამეგრელო (სენაკი)", lat: 42.4, lon: 42.07 , habitat: "mixed" },
    { name: "მდ. წყალწითელა", region: "იმერეთი (კვახჭირის მიდამოები, ქვედა დინება)", lat: 42.21, lon: 42.64 , habitat: "warm" },
    ...
    { name: "მდ. კინტრიში", region: "აჭარა (ქობულეთი)", lat: 41.8, lon: 41.95 , habitat: "mixed" },
...
// მომხმარებლის მოწოდებული გავრცელების სიის მიხედვით შედგენილი ბაზა.
// თითოეული სახეობისთვის ჩამოთვლილია ის ცნობილი წყლები, სადაც ის რეალურად ბინადრობს.
// თუ ცნობილი წყალი სიაში არაა → თევზი იქ არ გვხვდება.
// kalmahi (კალმახი) გამონაკლისია — ის ცივი წყლის თევზია და წყლის ტიპით მოწმდება.
const FISH_PRESENCE: Record<string, Set<string>> = {
  kashapi: new Set([
    "მდ. მტკვარი", "მდ. არაგვი (თეთრი, შავი, ფშავის, ხევსურეთის)", "მდ. ალაზანი", "მდ. იორი", "მდ. ხრამი",
    "მდ. რიონი", "მდ. ჭოროხი", "მდ. სუფსა", "მდ. ნატანები", "მდ. კინტრიში", "მდ. ხობისწყალი", "მდ. ენგური",
    "მდ. კოდორი", "მდ. ბზიფი", "მდ. ყვირილა", "მდ. ხანისწყალი", "მდ. ტეხური", "მდ. წყალწითელა",
    "მდ. ჩხერიმელა", "მდ. ჭიშურა", "მდ. ჩხარა",
    "მდ. აბაშა", "მდ. ცხენისწყალი", "მდ. აჭარისწყალი", "მდ. ჩაქვისწყალი", "მდ. ფსოუ",
    "ტყიბულის წყალსაცავი",
    "პალიასტომი", "ფარავნის ტბა", "საღამოს ტბა", "ბაზალეთის ტბა", "ჯანდარის ტბა",
    "თბილისის ზღვა (წყალსაცავი)", "ფალდოს (სიონის) წყალსაცავი", "წალკის წყალსაცავი",
    "ჟინვალის წყალსაცავი", "შაორის წყალსაცავი",
  ]),
  korchila: new Set([
    "თბილისის ზღვა (წყალსაცავი)", "ჟინვალის წყალსაცავი", "წალკის წყალსაცავი", "ტაბაწყური", "ფარავნის ტბა",
    "ფალდოს (სიონის) წყალსაცავი", "შაორის წყალსაცავი", "ტყიბულის წყალსაცავი", "ლისის ტბა",
  ]),
  kariklapi: new Set([
    "პალიასტომი", "მდ. რიონი", "მდ. ხობისწყალი", "მდ. სუფსა", "მდ. ენგური", "მდ. კოდორი",
    "მდ. აბაშა", "მდ. ტეხური",
    "თბილისის ზღვა (წყალსაცავი)", "ჟინვალის წყალსაცავი", "ფალდოს (სიონის) წყალსაცავი", "მდ. ალგეთი",
    "წალკის წყალსაცავი", "შაორის წყალსაცავი",
  ]),
  shamaya: new Set([
    "თბილისის ზღვა (წყალსაცავი)", "ჟინვალის წყალსაცავი", "ფალდოს (სიონის) წყალსაცავი", "ჯანდარის ტბა",
    "მდ. მტკვარი", "მდ. ალაზანი", "მდ. რიონი", "მდ. ენგური", "მდ. აბაშა",
    // დასავლეთის მდინარეები — ქვემო (დაბლობი) წელი
    "მდ. ცხენისწყალი", "მდ. ყვირილა", "მდ. ხანისწყალი", "მდ. ჩხერიმელა", "მდ. ჭოროხი",
    "მდ. აჭარისწყალი", "მდ. კოდორი", "მდ. ბზიფი", "მდ. ხობისწყალი", "მდ. ტეხური",
    "მდ. წყალწითელა", "მდ. სუფსა", "მდ. ნატანები", "მდ. კინტრიში",
  ]),
};

// მაგალითი-ადგილები „აქ არ ბინადრობს" შეტყობინებისთვის
const FISH_ABSENT_HINT: Record<string, string> = {
  kashapi: "მაგ. მტკვარი, რიონი, ალაზანი, იორი, ჭოროხი, ენგური, ფარავნის ტბა, თბილისის ზღვა",
  korchila: "მაგ. თბილისის ზღვა, ჟინვალი, წალკის წყალსაცავი, ტაბაწყური, ფარავანი, ლისის ტბა",
  kariklapi: "მაგ. პალიასტომი, რიონი, ენგური, სუფსა, თბილისის ზღვა, ჟინვალი, სიონი, წალკის წყალსაცავი",
  shamaya: "მაგ. მტკვარი, ალაზანი, რიონი, ენგური, ჭოროხი, სუფსა, ყვირილა, თბილისის ზღვა, ჯანდარის ტბა",
};
...
export function checkFishHabitat(fishKey: string, water: WaterInfo): HabitatCheck {
  ...
  const presence = FISH_PRESENCE[fishKey];
  if (presence) {
    if (presence.has(water.name)) {
      // შამაია მდინარეებში ძირითადად ქვემო (დაბლობ) წელში გვხვდება
      if (fishKey === "shamaya" && water.name.startsWith("მდ.") && water.habitat !== "warm") {
        return {
          ok: true,
          note: `ℹ️ ${fishName} ამ მდინარეში ძირითადად ქვემო (დაბლობ) წელშია გავრცელებული — მთიან ზემო წელში ვერ შეხვდები.`,
        };
      }
      return { ok: true };
    }
    return {
      ok: false,
      message: `ვწუხვართ — ${fishName} აქ არ ბინადრობს. ის შემდეგ წყლებშია გავრცელებული — ${FISH_ABSENT_HINT[fishKey]}.`,
    };
  }
...
export function weatherDesc(code: number): string {
  const codes: Record<number, string> = {
    ...
    56: "ყინულოვანი ნამძენი", 57: "ძლიერი ყინულოვანი ნამძენი",
    61: "სუსტი წვიმა", 63: "შუალედური წვიმა", 65: "ძლიერი წვიმა",
    66: "ყინულოვანი წვიმა", 67: "ძლიერი ყინულოვანი წვიმა",
    71: "სუსტი თოვლი", 73: "შუალედური თოვლი", 75: "ძლიერი თოვლი",
    77: "თოვლის მარცვლები",
    80: "სუსტი თქეშური წვიმა", 81: "თქეშური წვიმა", 82: "ძლიერი თქეშური წვიმა",
    85: "სუსტი თქეშური თოვლი", 86: "ძლიერი თქეშური თოვლი",
