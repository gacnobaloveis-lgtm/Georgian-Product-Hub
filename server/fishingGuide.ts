...
const KORCHILA_EXTRA_ABSENT = ["მდ. ყვირილა", "მდ. სუფსა", "მდ. ნატანები", "მდ. აბაშა", "მდ. ჭოროხი", "მდ. ტეხური", "მდ. ხანისწყალი", "მდ. ცხენისწყალი",
  "მდ. დიდი ლიახვი", "მდ. პატარა ლიახვი", "მდ. ქსანი", "მდ. ძამა", "მდ. ტანა", "მდ. თეძამი",
  "მდ. ჩხერიმელა", "მდ. ენგური", "მდ. აჭარისწყალი", "მდ. ხობისწყალი", "მდ. კინტრიში"];

// ქარიყლაპია საქართველოში მხოლოდ დასავლეთის — შავი ზღვის აუზის — წყლებში ბინადრობს.
// მტკვრის (კასპიის) აუზში (აღმოსავლეთ საქართველო) ბუნებრივად არ გვხვდება.
const BLACK_SEA_BASIN = new Set([
  "მდ. რიონი", "მდ. ცხენისწყალი", "მდ. ყვირილა", "მდ. ხანისწყალი", "მდ. ჯეჯორა", "მდ. ჩხერიმელა",
  "მდ. ენგური", "მდ. ჭოროხი", "მდ. აჭარისწყალი", "მდ. კოდორი", "მდ. ბზიფი", "მდ. ხობისწყალი",
  "მდ. ტეხური", "მდ. აბაშა", "მდ. სუფსა", "მდ. ნატანები", "მდ. კინტრიში", "მდ. ჩაქვისწყალი", "მდ. ფსოუ",
  "რიწის ტბა", "პალიასტომი", "პატარა რიწა", "ამტყელის ტბა", "ეწერის ტბა", "ტობავარჩხილი", "ორეთის ტბა",
  "მწვანე ტბა", "ენგურის წყალსაცავი", "ტყიბულის წყალსაცავი", "შაორის წყალსაცავი", "ვარციხის წყალსაცავი",
  "გალის წყალსაცავი",
]);
...
export function checkFishHabitat(fishKey: string, water: WaterInfo): HabitatCheck {
  ...
  if (fishKey === "kariklapi") {
    if (!BLACK_SEA_BASIN.has(water.name)) {
      return {
        ok: false,
        message: `ვწუხვართ — ${fishName} აქ არ ბინადრობს. საქართველოში ის მხოლოდ დასავლეთის (შავი ზღვის აუზის) წყლებშია გავრცელებული — მაგ. რიონი, ენგური, პალიასტომი, კოლხეთის ჭაობები.`,
      };
    }
    if (water.habitat === "cold") {
      return {
        ok: false,
        message: `ვწუხვართ — ${fishName} აქ არ ბინადრობს: წყალი ზედმეტად ცივი და სწრაფია მისთვის.`,
      };
    }
    if (water.habitat === "mixed" && isRiver) {
      return {
        ok: true,
        note: `ℹ️ ${fishName} ამ მდინარეში მხოლოდ ქვემო, მდორე და მცენარეებით მდიდარ წელში გვხვდება.`,
      };
    }
    return { ok: true };
  }

  // თბილი წყლის თევზები: ქაშაპი, შამაია
  if (water.habitat === "cold") {
    return {
      ok: false,
