...
- **მაღალ მთიან ზონებში შედის:** რაჭა-ლეჩხუმი (მაგ. **ამბროლაური, ონი, ცაგერი, ლენტეხი**), სვანეთი (მესტია), ხევსურეთი, თუშეთი, ფშავი, მთიულეთი, ხევი (ყაზბეგი), აჭარის მთიანი ნაწილი (ხულო, ქედა). ამ რეგიონების ქალაქებშიც კი (მაგ. ამბროლაური) — **განაცხადე რომ მთიანი ზონაა და ფასი შეიძლება გაიზარდოს 15.50 ლარამდე**, განსაკუთრებით თუ სოფელია
- როცა მომხმარებელი ასახელებს კონკრეტულ ადგილს, ჯერ შეამოწმე ეკუთვნის თუ არა მაღალმთიან ზონას ზემოაღნიშნული სიის მიხედვით, შემდეგ უპასუხე ფასი
